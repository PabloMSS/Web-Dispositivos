...
var imagenes =["<a href= https://www.xataka.com/analisis/iphone-12-analisis-caracteristicas-precio-especificaciones><img src=../recursos_pablom/imagenespablom/iphone12.jpg></a>", 
	...
	"<a href=https://www.xataka.com/analisis/iphone-x-analisis-caracteristicas-precio-y-especificaciones><img src=../recursos_pablom/imagenespablom/oppofindx3pro.jpg></a>",
	...
	"<a href=https:https://www.xataka.com/analisis/samsung-galaxy-z-fold-2-analisis-caracteristicas-precio-especificaciones><img src=../recursos_pablom/imagenespablom/galaxyzfold2.jpg></a>",
...
function cambioImg5(){
	document.getElementById("img5").src="recursos_pablom/imagenespablom/capapersonalizacion3.jpg";
}
function revertirImg5(){
	document.getElementById("img5").src="recursos_pablom/imagenespablom/marcas.jpg";
}

function cambioImg6(){
	document.getElementById("img6").src="recursos_pablom/imagenespablom/capapersonalizacion2.jpg";
}
function revertirImg6(){
	document.getElementById("img6").src="recursos_pablom/imagenespablom/capapersonalizacion.jpg";
}
